...
const RegisterModal = ({ onClose }) => {
  ...
  const handleSwitchToLogin = () => onClose();
        ...
        <form onSubmit={handleSubmit} className="register-form">
          ...
          <div className="input-group">
            ...
            {formData.password && (
              <div className="password-strength-container">
                ...
                {strength.text && (
                  <div className="password-strength-label" style={{ color: strength.color }}>{strength.text}</div>
                )}
              </div>
            )}
              ...
              <div className="password-requirements">
                ...
                <div className="requirements-list">
                  {[
                    ...
                    <div key={key} className={`requirement-item ${passwordValidation[key] ? 'valid' : ''}`}>
                      <svg viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="login-section">
            <p>Already have an account?{" "}
              <button type="button" className="login-link" onClick={handleSwitchToLogin}>
                Log in here
              </button>
            </p>
          </div>
